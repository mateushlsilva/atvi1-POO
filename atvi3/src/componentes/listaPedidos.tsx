            ...
            <div>
                ...
                <div className='container'>
                    <div className="collection">
                        <a className="collection-item" style={fontcolor} href="/pedidos">Pedido 1</a>
                        <a className="collection-item" style={fontcolor} href="/pedidos">Pedido 2</a>
                        <a className="collection-item" style={fontcolor} href="/pedidos">Pedido 3</a>
                    </div>
                </div>
            </div>
        )
